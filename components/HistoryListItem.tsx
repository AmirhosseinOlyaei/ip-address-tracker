...
export function HistoryListItem({
  ...
  return (
    <Animated.View style={animatedStyle}>
      ...
      >
        <View
          style={[styles.iconContainer, { backgroundColor: `${c.tint}15` }]}
        >
          <Ionicons name="location" size={18} color={c.tint} />
        </View>

        <View style={styles.content}>
          <Text style={[styles.query, { color: c.text }]} numberOfLines={1}>
            {entry.query}
          </Text>
          <Text
            style={[styles.location, { color: c.textSecondary }]}
            numberOfLines={1}
          >
            {location}
          </Text>
          <Text style={[styles.isp, { color: c.textMuted }]} numberOfLines={1}>
            {data.isp}
          </Text>
        </View>
